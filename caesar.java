public class Caesar {
  ...
  public String code(String plaintext, int key) {
    ...
    for (int i = 0; i < plaintext.length(); i++) {  // Buchstaben verschieben und an Geheimtext haengen
  ...
  public char shift(char letter, int shift) {  // Buchstaben als Zahl behandeln
  ...
  public String decode(String ciphertext, int key) {
    ...
    for (int i = 0; i < ciphertext.length(); i++) {    // Jeden Buchstaben verschieben und zwar um (26-Schluessel(key)) Stellen und an entschlüsselten Text anhaengen
